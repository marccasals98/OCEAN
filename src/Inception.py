...
class InceptionA(nn.Module):
    '''
    Aquest module és el que més s'assembla a l'inception de GoogLeNet. Crec que té 
    algunes diferències, com que en un dels blocs fa una convolució extra així de
    gratis.
    '''
    ...
    def __init__(self, in_channels, pool_features):
        ...
        self.branch3x3dbl_3 = BasicConv2d(96, 96, kernel_size=3, padding=1) # aquesta convolution pq?
